...
ETL_Info = {
    ...
    'PET': [116.1, 168.9, 206.6, 231.3, 201.4, 172, 104.2, 56.9, 38, 39.8, 49.6, 81.1],
    'Eff_Precipitation': [25.8, 17.6, 6.0, 0.6, 0.1, 0.4, 2.7, 7.8, 11.8, 16.5, 19.7, 28.7],
...
# %% Report ETL
tmpG = final_result.groupby(['Region', 'District'])

tmp = tmpG.agg({'SubIrrigation_Area': 'sum',
                'ETL_YEAR': 'mean',
                'IrriReq_YEAR': 'sum'})

tmp = tmp.reset_index().rename(columns={'Region': 'منطقه',
                                        'District': 'ناحیه',
                                        'SubIrrigation_Area': 'مساحت تحت آبیاری - مترمربع',
                                        'ETL_YEAR': 'نیاز آبیاری - میلیمتر در سال',
                                        'IrriReq_YEAR': 'نیاز آبیاری سالانه - هزار مترمکعب'})
